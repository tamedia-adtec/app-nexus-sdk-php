...
class AppNexus_Reporting
{
    ...
    {
        $reportId = AppNexus_ReportService::requestReport(
    ...
    {
        $response = AppNexus_ReportService::getReport($reportId);
    ...
    public function downloadReport($reportId)
    {
        ...
        // download the report
        $downloadReport = AppNexus_ReportService::downloadReport($reportId);
    ...
    {
        $reportId = AppNexus_ReportService::getSavedReportId($id);
        $this->setReportId($reportId);
        return $this->downloadReport($reportId);
    }
    ...
    {
        $initialReport = AppNexus_ReportService::downloadReport($id);
        ...
        $advertiserFiltersAndMetrics = array_merge(AppNexus_Reports_AdvertiserAnalytics::getFilters(), AppNexus_Reports_AdvertiserAnalytics::getMetrics(), AppNexus_Reports_AdvertiserAnalytics::getTimeGroups());
        $siteDomainFiltersAndMetrics = array_merge(AppNexus_Reports_SiteDomainPerformance::getFilters(), AppNexus_Reports_SiteDomainPerformance::getMetrics(), AppNexus_Reports_SiteDomainPerformance::getStaticFilters());
     ...
     * @return AppNexus_Reporting $this
     */
     ...
     *
     * @param array $filters
     * @return AppNexus_Reports_AdvertiserAnalytics $this
     */
